...
def add_random_blur(image, MIN_BLUR = 1, MAX_BLUR = 5):
    max_blur = MAX_BLUR
    ...
    intensity = randint(MIN_BLUR, max_blur)
...
def add_random_gauss_noise(image, MIN_GAUSS_NOISE = 1, MAX_GAUSS_NOISE = 300):
    intensity = randint(MIN_GAUSS_NOISE, MAX_GAUSS_NOISE)
